...
export const MENU_DATA: Product[] = [
  // Hamburguesas
  {
    ...
    image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1594212699903-ec8a3e28c64b?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1551782450-a2132b4ba21d?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    id: 4, name: 'Ranchera',
    ...
    image: 'https://images.unsplash.com/photo-1627907228175-2bf846a303b4?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1547584370-2cc98b8b8dc8?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1603353443219-c684074a10f7?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1605478377395-f2a8a5f3142b?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    id: 8, name: 'Madurito',
    ...
    image: 'https://images.unsplash.com/photo-1606131731446-5568d87113aa?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    id: 9, name: 'Campeche',
    ...
    image: 'https://images.unsplash.com/photo-1605298711911-818581667d4f?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1596662951482-0c4ba74a6df6?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1626078298452-a5679ba24918?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1607013251379-e6eecfffe234?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Cebolla Grille', 'Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1562967914-608f82629710?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Hamburguesas,
    baseIngredients: ['Lechuga', 'Tomate', 'Salsas']
  },
  // Perros
  {
    ...
    image: 'https://images.unsplash.com/photo-1616650990240-a9b3a33a3ef4?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Perros,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1541287627918-5f5a434315f5?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Perros,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  {
    id: 16, name: 'Especial',
    ...
    image: 'https://images.unsplash.com/photo-1599599810694-b5b37304c041?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Perros,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  {
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1554522955-2d8bAc81a3f3?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Perros,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  {
  ...
  // Salchipapas
  {
    ...
    price: 12000, image: 'https://images.unsplash.com/photo-1628736209745-ef225339281d?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Salchipapas,
  ...
  },
  {
    ...
    price: 17500, image: 'https://images.unsplash.com/photo-1634818274945-38a47f201460?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Salchipapas,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  {
    ...
    price: 28000, image: 'https://images.unsplash.com/photo-1585325701166-7815d6d33931?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Salchipapas,
  ...
  // Choripapas
  {
    ...
    price: 13000, image: 'https://images.unsplash.com/photo-1625944330383-703a14704e28?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Choripapas,
    baseIngredients: ['Salsas']
  },
  {
    id: 27, name: 'Choripollo',
    description: 'Chorizo, pollo desmechado, queso, cebolla grille, papas a la francesa y salsas de la casa.',
    price: 18500, image: 'https://images.unsplash.com/photo-1625944330383-703a14704e28?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Choripapas,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  // Papas Locas
  {
    ...
    image: 'https://images.unsplash.com/photo-1598679253444-c340e3db59e2?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Papas_Locas,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1613584347743-3069a53a479b?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Papas_Locas,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
  // Sandwiches
  {
    ...
    price: 9000, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Sandwiches,
    baseIngredients: ['Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    price: 16000, image: 'https://images.unsplash.com/photo-1626082933448-f67423a8e8b0?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Sandwiches,
    baseIngredients: ['Lechuga', 'Tomate', 'Salsas']
  },
  {
    ...
    price: 18500, image: 'https://images.unsplash.com/photo-1544030288-e8ab6c883a9a?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Sandwiches,
    baseIngredients: ['Lechuga', 'Tomate', 'Salsas']
  },
  // Alternativas
  {
    ...
    price: 40000, image: 'https://images.unsplash.com/photo-1625938139304-410055f19c39?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Alternativas,
  ...
  },
  {
    ...
    price: 19500, image: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Alternativas
  },
  {
    id: 35, name: 'Pechuga a la Plancha',
    description: 'Pechuga, ensalada, papas a la francesa y salsas de la casa.',
    price: 21000, image: 'https://images.unsplash.com/photo-1604503468826-b29c11aa95e8?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Alternativas
  },
  {
    id: 36, name: 'Carne a la Plancha',
    description: 'Carne, ensalada, papas a la francesa y salsas de la casa.',
    price: 24500, image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Alternativas
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1582235450320-a7b0a7010534?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Alternativas,
    baseIngredients: ['Cebolla Grille', 'Salsas']
  },
   // Bebidas
  {
    id: 46, name: 'Coca-Cola', description: 'Personal 400ml', price: 4000, image: 'https://images.unsplash.com/photo-1622483767028-3f66f32a6444?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Bebidas
  },
  {
    id: 47, name: 'Jugo de Mora en Agua', description: 'Natural', price: 5000, image: 'https://images.unsplash.com/photo-1620713797960-e4b9f2e34220?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Bebidas
  },
  {
    id: 48, name: 'Jugo de Mora en Leche', description: 'Natural', price: 6000, image: 'https://images.unsplash.com/photo-1620713797960-e4b9f2e34220?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Bebidas
  },
  {
    id: 49, name: 'Limonada Natural', description: 'Refrescante', price: 5000, image: 'https://images.unsplash.com/photo-1575596511261-20a28330c6a2?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Bebidas
  },
  {
    id: 50, name: 'Cerveza Club Colombia', description: 'Dorada', price: 6000, image: 'https://images.unsplash.com/photo-1618885472179-5e4740292458?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Bebidas
  },
  // Adicionales
  {
    id: 38, name: 'Pollo Desmechado', description: '', price: 4000, image: 'https://images.unsplash.com/photo-1598103442345-0c414166266e?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 39, name: 'Maíz Dulce', description: '', price: 4000, image: 'https://images.unsplash.com/photo-1598912534831-23c5e8c37432?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 40, name: 'Aros de Cebolla', description: '', price: 3500, image: 'https://images.unsplash.com/photo-1549911078-f6e4d588143d?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 41, name: 'Porción de Papa Francesa', description: '', price: 7000, image: 'https://images.unsplash.com/photo-1576107232684-1279f390859f?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 42, name: 'Chorizo', description: '', price: 4000, image: 'https://images.unsplash.com/photo-1583232021510-742767078342?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 43, name: 'Salchicha', description: '', price: 4000, image: 'https://images.unsplash.com/photo-1554522955-2d8bAc81a3f3?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 44, name: 'Carne de Hamburguesa', description: '', price: 6000, image: 'https://images.unsplash.com/photo-1619894991192-f01835d19ad1?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
  {
    id: 45, name: 'Tocineta', description: '', price: 3500, image: 'https://images.unsplash.com/photo-1606821197148-913df9620331?q=80&w=400&h=300&fit=crop&crop=entropy', category: Category.Adicionales
  },
];
